...
def read_document_text_preview(document_id: str) -> DocumentTextPreviewResponse:
    return get_pdf_text_preview(document_id)

@router.post("/documents/{document_id}/convert-docx")
def convert_document_to_docx(document_id: str) -> Response:
...
def convert_document_to_docx_ai(document_id: str, request: DocxAiConvertRequest) -> Response:
...
def convert_document_to_excel(document_id: str) -> Response:
...
def convert_document_to_excel_template(document_id: str) -> Response:
...
def export_document_page_images(document_id: str) -> Response:
...
def merge_documents(request: MergePdfRequest) -> Response:
...
def compress_document(document_id: str) -> Response:
